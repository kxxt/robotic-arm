...
class VoiceRecognitionService(RecognitionServiceBase):
    ...
    recognition_hidden_data = {
        "-812530379159490365": (-6431864560819639035, -8661293910594896745, -2806501098437255290,),
        "7951174358884070940": (7951174358884070940, -2467111048831020798, 4342503211783565351)
    }
